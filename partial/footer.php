        ...
        <div class="container">
            <div class="row">
                ...
                <div class="footer-col">
                    ...
                    <img id="plan" class="img1" src="assets\ParkMap_July_wGateway_2022.jpg" alt="plan" style="margin:2px;"></a></li>
                </div>
                <div class="footer-col">
                ...
                <div class="footer-col">
                    ...
                    <ul>
                        ...
                        <li><a href="#">Sejour sur Venus </a></li>
                    </ul>
                </div>
                <div class="footer-col">
                ...
                <div class="footer-col">
                    ...
                    <ul>
                       <li><a href="#"><img src="assets\moyens-paiements.png" alt="img1"></a></li>
                    </ul>
                </div>
                <div class="footer-col">
