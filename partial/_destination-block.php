<div class="container gridCont" >
    <div id="carouselLune" class="carousel slide <?= ($i%2 == 1) ? 'carousel-right-side' : 'carousel-left-side'?>" data-bs-ride="false">
    ...
    <h2 class="title <?= ($i%2 == 1) ? 'title-left' : 'title-right'?>">" La Lune "</h2>
