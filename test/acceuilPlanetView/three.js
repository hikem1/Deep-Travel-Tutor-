...
// set params to true or false
function visibleDestinationsPlanets(showEarth, showMoon, showVenus, showMars, showMercure){
  earth.visible = showEarth;
  moon.visible = showMoon;
  venus.visible = showVenus;
  mars.visible = showMars;
  mercure.visible = showMercure;
}
...
export { scene, camera, renderer, moon, earth, venus, mars, mercure, visibleDestinationsPlanets };
